...
interface Vm {
    ...
    function assertionEx(bytes calldata tx, address assertionAdopter, bytes[] assertions) external returns (uint256 total_assertion_gas, uint256 total_assertions_ran);
